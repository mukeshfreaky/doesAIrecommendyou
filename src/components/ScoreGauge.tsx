...
export const ScoreGauge: React.FC<Props> = ({ score }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Main Answer Card */}
      <div className={`relative overflow-hidden rounded-xl border ${tier.border} bg-zinc-950 p-6 sm:p-7 shadow-sm space-y-6 text-left`}>
        <div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pt-2">
          ...
          <div className="space-y-2 max-w-xl">
            <div className="flex items-baseline gap-3">
              {hasProspectiveEvaluations ? (
                <>
                  ...
                  <span className="text-lg font-medium text-zinc-500 font-mono">/ 100</span>
                </>
              ) : (
            ...
            {hasProspectiveEvaluations ? (
              <div className={`text-xs font-semibold ${tier.color} flex items-center gap-2 font-mono uppercase tracking-wider`}>
          ...
          {hasProspectiveEvaluations && (
            <div className="grid grid-cols-3 gap-4 w-full md:w-auto border-t md:border-t-0 md:border-l border-zinc-800 pt-4 md:pt-0 md:pl-8">
              <div className="text-center md:text-left">
                <div className="text-2xl sm:text-3xl font-bold text-emerald-400 font-mono">
                  {topRecommendationRate}%
                </div>
                <div className="text-[11px] text-zinc-400 mt-1 leading-tight font-mono">
                  Top Choice (#1)
                </div>
              </div>

              <div className="text-center md:text-left border-x border-zinc-800 px-3 md:px-4">
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-950/80 p-6 sm:p-7 text-left">
        ...
        <div className="mt-4 pt-3 border-t border-zinc-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-zinc-400">
          ...
          <span className="text-[11px] text-zinc-500 shrink-0 italic">
